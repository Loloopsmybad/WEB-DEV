...
export default function FeePendingCasesPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Fee Release Pending Allotted Cases</h1>
        <p className="text-gray-500">Cases where fee release is pending</p>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              {filteredCases.length === 0 && (
                <tr><td colSpan={9} className="px-4 py-8 text-center text-gray-500">No fee pending cases found</td></tr>
              )}
            </tbody>
          </table>
        </div>
